...
dados <- read.xlsx("JuncaoPrecoMilhoB3eJPA.xlsx", sheet = 1)
...
train_automl(data_tbl, save_dir = "C:/Users/Sergio/OneDrive/ANALISES/FAPEMIG/dashboard/DASHBOARDMILHO/d1/exemplosergio/models11JPA/")
